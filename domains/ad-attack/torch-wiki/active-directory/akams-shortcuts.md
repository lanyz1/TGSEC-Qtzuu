...
type: technique
tags: [azure, cloud, enumeration, m365, reference-import]
phase: recon
...
The aka.ms URL shortener resolves Microsoft-internal short links to direct service endpoints, admin portal URLs, and documentation pages. Attackers use publicly documented aka.ms shortcuts to quickly navigate to Azure AD admin portals, O365 compliance centers, and identity-related configuration pages during a cloud assessment without needing to know the full portal URL. Some shortcuts expose tenant-specific endpoints that reveal configuration details useful for enumeration.
