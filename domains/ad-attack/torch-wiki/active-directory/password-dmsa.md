...
Delegated Managed Service Accounts (dMSA) are a Windows Server 2025 feature that replaces managed service accounts and supports migration from existing service accounts; the BadSuccessor vulnerability (CVE-2025-29895) exploits dMSA creation permissions. An attacker with create-object permissions on any OU can create a new dMSA that claims to have "succeeded" an existing privileged account, causing the KDC to issue Kerberos tickets containing that account's SID in the PAC for the dMSA. This effectively impersonates any domain account, including Domain Admins, without needing their password or hash.
...
[diagram: BadSuccessor dMSA attack flow](https://www.akamai.com/site/en/images/blog/2025/badsuccessor-image5.png)
