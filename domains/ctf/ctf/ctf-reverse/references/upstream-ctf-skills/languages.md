...
**Tool selection by Python version:** `uncompyle6` supports Python 2.x–3.8. For Python 3.9+ bytecode, use [`pycdc`]([upstream-repo]) (compile from source: `git clone && cmake . && make`).
