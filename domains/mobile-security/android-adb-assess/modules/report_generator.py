"""
android-adb-assess — Report Generator Module
...
<title>android-adb-assess — Security Report</title>
<style>
...
<header>
  <div>
    <div class="logo">👻 android-adb-assess<span>Advanced Android Pentesting Framework</span></div>
  </div>
  <div class="meta">
    <div class="target">{target}</div>
    <div>Generated: {timestamp}</div>
    <div>Report ID: {report_id}</div>
    <div>Author: TGSEC | @TGSEC</div>
  </div>
</header>
<main>
...
<footer>
  <p>android-adb-assess &copy; 2026 | Author: <a href="https://www.instagram.com/TGSEC">TGSEC</a> | For authorized use only</p>
</footer>
</body>
</html>
"""
...
def generate_html_report(data: dict, output: str = "android-adb-assess_report.html") -> str:
...
def generate_json_report(data: dict, output: str = "android-adb-assess_report.json") -> str:
    """Generate a structured JSON report."""
    report = {
        "tool": "android-adb-assess",
        "author": "TGSEC | @TGSEC",
...
def print_summary_table(data: dict):
    ...
    t = Table(title="[bold magenta]📋 android-adb-assess — Findings Summary[/]",
