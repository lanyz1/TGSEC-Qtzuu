...
6. **Wordlist availability** — confirm SecLists is cloned:
   ```bash
   ls /usr/share/seclists/Discovery/Web-Content/common.txt >/dev/null 2>&1 && echo "PASS: SecLists present" || echo "FAIL: git clone [upstream-repo] /usr/share/seclists"
   ```
...
curl --max-time 30 --connect-timeout 10 -s https://raw.githubusercontent.com/TGSEC/bb-agent-methods/main/SKILL.md \
