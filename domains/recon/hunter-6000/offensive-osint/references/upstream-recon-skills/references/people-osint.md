...
| Tool | Purpose |
|------|---------|
| [Sherlock]([upstream-repo]) | Username search across social networks |
| [Maigret]([upstream-repo]) | Profile collector by username |
| [What's My Name](https://whatsmyname.app/) | Username search |
| [Holehe]([upstream-repo]) | Email registration check |
...
| [PhoneInfoga]([upstream-repo]) | Phone number intelligence |
...
| X/Twitter | [snscrape]([upstream-repo]) — preferred CLI scraper; Twint as fallback |
