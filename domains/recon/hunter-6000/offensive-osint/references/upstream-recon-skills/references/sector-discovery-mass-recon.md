...
- **Background process output buffering** — Python scripts run as background processes buffer stdout by default. Use `PYTHONUNBUFFERED=1 python3 -u script.py` to see live output. Without this, you cannot monitor progress until the process exits.
