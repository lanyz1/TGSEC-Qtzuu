...
- Static: [pefile]([upstream-repo]), [FLOSS]([upstream-repo]), [capa]([upstream-repo]).
...
- TLS: [JA3]([upstream-repo]), [JA4]([upstream-repo]).
...
| **Trickest CVE → POC mapping** | `[upstream-repo]` | Auto-generated CVE → public POC repo links. |
