...
type: technique
tags: [initial-access, m365, phishing, reference-import, windows]
phase: exploitation
...
Technical reference for **Office - Attacks** collected from InternalAllTheThings during an internal/cloud assessment ingest.

## How it works

Microsoft Office files (DOCM, XLSM, XLL, SLK) can embed macros, Excel 4.0 XLM formulas, and DLL add-ins that execute arbitrary code when the document is opened and macros are enabled. Attackers craft malicious Office documents using tools like Metasploit, SharpShooter, or custom VBA to download and execute payloads, spawn reverse shells, or abuse COM objects for stealthy execution. The diversity of execution mechanisms (VBA, XLM, XLL, DCOM-WMI, remote templates) allows attackers to adapt to different security control configurations that may block specific macro types while permitting others.
...
[diagram: Office document feature support by product](https://www.securesystems.de/images/blog/offphish-phishing-revisited-in-2023/Office_documents_feature_overview.png)
...
[diagram: AMSI runtime scanning flow](https://www.microsoft.com/security/blog/wp-content/uploads/2018/09/fig2-runtime-scanning-amsi-8-1024x482.png)
