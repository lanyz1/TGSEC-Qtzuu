...
| Tool | Purpose | Source |
|------|---------|--------|
| TokenTactics v2 | Generate device codes and refresh tokens across M365 services | [upstream-repo] |
| ROADtools (roadrecon / roadtx) | Token exchange, directory enumeration, access mapping | [upstream-repo] |
| AADInternals | Entra ID attack/recon PowerShell toolkit | [upstream-repo] |
